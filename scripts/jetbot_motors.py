...
last_x = -999
last_rot = -999
wheel_separation = 0.1016	# 4 inches
wheel_diameter = 0.060325	# 2 3/8 inches
max_pwm = 255
max_rpm = 200		## https://www.adafruit.com/product/3777
left_trim = 0.0
right_trim = 0.0	
...
if __name__ == '__main__':
	...
	rospy.Subscriber("/cmd_vel", Twist, on_cmd)
